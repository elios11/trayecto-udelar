...
- De las proyecciones generadas, 97 tienen composición utilizable y 78 permanecen seleccionables con un estado vacío explícito. Fisioterapia e Imagenología 2006 usan las 29 unidades publicadas para cada carrera por Facultad de Medicina y conservan créditos en cero porque sus planes vigentes están expresados en horas.
- Dieciséis planes generados incorporan sedes respaldadas por auditoría oficial; las opciones territoriales no se extrapolan a los restantes planes. Imagenología explicita Montevideo y Paysandú como carrera completa y Río Negro sólo para tercer y cuarto año, sin crear una trayectoria curricular. Fisioterapia ofrece una única malla en Montevideo y Paysandú.
- El manifiesto reproducible es `data/bedelias/inventory/ui-extracted-plans.json`, con hash de reporte `sha256:342796e8c6685ce673e5607a9251909e4857aab15aba3b97e3f4603475c4a5a2`.
