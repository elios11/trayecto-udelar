...
- De las proyecciones generadas, 96 tienen composición utilizable y 79 permanecen seleccionables con un estado vacío explícito. Archivología y Bibliotecología 2012 usan sus mallas oficiales vigentes de FIC; Fisioterapia 2006 usa las 29 unidades publicadas por Facultad de Medicina y conserva créditos en cero porque el plan vigente está expresado en horas.
- Quince planes generados incorporan sedes respaldadas por auditoría oficial; las opciones territoriales no se extrapolan a los restantes planes. Fisioterapia Plan 2006 ofrece una única malla en Montevideo y Paysandú. Ingeniería Biológica Plan 2013 presenta Montevideo y Salto como tramos iniciales y Paysandú como carrera completa, sin inventar una trayectoria regional ni perfiles cerrados.
- El manifiesto reproducible es `data/bedelias/inventory/ui-extracted-plans.json`, con hash de reporte `sha256:25dbc8d8750bd226a333fab783c8a54e015fc028012faa4dccae7f0dbaf5b092`.
