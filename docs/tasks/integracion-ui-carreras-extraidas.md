...
- De las proyecciones generadas, 98 tienen composición utilizable y 77 permanecen seleccionables con un estado vacío explícito. Fisioterapia, Imagenología e Instrumentación Quirúrgica 2006 usan sus unidades publicadas por Facultad de Medicina y conservan créditos en cero porque sus planes vigentes están expresados en horas.
- Diecisiete planes generados incorporan sedes respaldadas por auditoría oficial; las opciones territoriales no se extrapolan a los restantes planes. Instrumentación Quirúrgica ofrece la misma malla en Montevideo y Paysandú. Imagenología explicita además Río Negro sólo para tercer y cuarto año, sin crear una trayectoria curricular.
- El manifiesto reproducible es `data/bedelias/inventory/ui-extracted-plans.json`, con hash de reporte `sha256:f917e6d66a56f53a7f9e6df1f159a116daef79cbe43cd0c7af70aea8998e75c3`.
