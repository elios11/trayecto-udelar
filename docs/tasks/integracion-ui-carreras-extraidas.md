...
- De las proyecciones generadas, 93 tienen composición utilizable y 82 permanecen seleccionables con un estado vacío explícito porque Bedelías no publicó una composición suficiente.
- Once planes generados incorporan sedes respaldadas por auditoría oficial; las opciones territoriales no se extrapolan a los restantes planes. Trabajo Social Plan 2009 ofrece Montevideo y Salto como sedes de una única malla. Profesionalización Plan 1999 conserva Montevideo, Mercedes y Colonia del Sacramento como cohortes del mismo programa, con composición no publicada.
