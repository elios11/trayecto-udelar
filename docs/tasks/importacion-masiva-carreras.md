...
- FQ y CENURLN publican la misma composición de 453 apariciones. La diferencia de cobertura de previaturas no prueba una variante curricular: la proyección canónica conserva las 397 reglas publicadas por FQ y registra 149 consultas sin regla explícita.
