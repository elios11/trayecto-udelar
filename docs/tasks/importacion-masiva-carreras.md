...
- Tras completar el árbol central que había quedado truncado, la comparación local muestra las mismas 717 materias en FAGRO y CENURLN, sin faltantes ni cambios de créditos. La cobertura de previaturas regional sigue siendo menor (9 frente a 511), pero eso es una diferencia de publicación.
...
- Los tres snapshots conservan las mismas 38 entradas no flexibles. Tras completar el árbol de ISEF, el catálogo canónico tiene siete claves flexibles ausentes en CURE y CENURLN, sin claves exclusivamente regionales; la única colisión deduplicada de créditos es `L2113` y también es flexible. La cobertura de previaturas es 1197 en ISEF, 119 en CURE y 65 en CENURLN.
- Decisión: una identidad y una malla canónica, con selector de sede que filtre trayectos oficiales. Paysandú debe mostrar sólo Deporte y Salud; las diferencias del catálogo flexible no crean otra currícula ni habilitan trayectos adicionales.
...
### Bioquímico Clínico Plan 2015 — damero 2026 y primer año en Salto operativos 2026-09-01

- El Plan 2015, el damero aprobado por Resolución 112/2026, Facultad de Química y el catálogo vigente de Udelar confirman una única carrera de diez semestres y 450 créditos, con título `Bioquímico Clínico`. Montevideo dicta la carrera completa; Salto ofrece exclusivamente el primer año y luego se continúa en Montevideo con el mismo plan, título y progreso.
- La UI ofrece dos recorridos territoriales, no dos carreras: Montevideo muestra la secuencia sugerida vigente y conserva las demás alternativas en el catálogo; Salto muestra una orientación explícita y sólo las 17 unidades regionales de primer año identificadas por Bedelías. El tramo parcial no expone Practicantado, validación de egreso ni el catálogo completo como si pudieran cursarse allí.
- El damero vigente selecciona 323 créditos obligatorios en los ocho primeros semestres y un Practicantado único de 55 créditos para los semestres 9 y 10. Los 72 créditos optativos/electivos completan exactamente los 450 del título; el Practicantado no se duplica por aparecer en ambos semestres del documento.
- El egreso controla 219 créditos de formación básica —69 biológicos y biomédicos, 42 físico-matemáticos y 108 químicos—, 104 de formación profesional, 72 optativos/electivos con al menos 60 optativos, 55 de Practicantado, 450 totales y la validación del currículo flexible por la Comisión de Carrera.
- La Resolución 112/2026 reemplaza Bioquímica Opción III de 15 créditos por Bioquímica Opción II de 10 más Laboratorio de Bioquímica de 5. Bedelías asigna 10 créditos al código 512; para esta carrera la proyección usa los 5 específicos del damero vigente y deja trazada la discrepancia.
- FQ y CENURLN publican catálogos de 453 materias sin diferencias de códigos ni créditos. Tras completar el árbol central, el fingerprint detecta caminos de composición distintos; la evidencia oficial confirma que es una diferencia de publicación y no una variante curricular. La proyección canónica conserva 398 reglas publicadas por FQ y registra 148 consultas sin regla explícita.
- La proyección contiene 455 componentes: 453 entradas de composición, una orientación territorial y una validación final. Las versiones históricas y equivalencias permanecen disponibles en Montevideo, pero no se suman automáticamente ni sustituyen las versiones vigentes de la secuencia sugerida.
- Registro de auditoría: hash `sha256:4cbfa5c2102e7b1f539d72afdf8534873f10ee9d9720085023b7fda7ab9ce08e`. Cola general: 6 identidades pendientes; hash `sha256:9d2d9f6e1df55780aefbd3782dcab28dd76adf42545313d636f2030e3b899379`.
- Manifiesto UI: 139 proyecciones, todas con composición utilizable y 45 con sedes oficiales; hash `sha256:13b095d20489bc40aeafe901b3425dc7a6884eda67635f7c5f72835374871f18`. Cola funcional vacía; hash `sha256:0db5235ecefed4d8bf5e8c97fe6afbdef3938693b03167042164acef212cde8c`. La prueba determinista cubre identidad, sedes, damero, créditos, mínimos, filtro territorial, Practicantado, previaturas y avance de cola.
- El navegador integrado no está disponible en esta sesión; no se declara una nueva inspección visual manual. Permanecen activas las pruebas estructurales de temas y adaptación móvil/tablet.
- Siguiente paso: auditar Licenciatura en Química Plan 2016, primera identidad reproducible restante.

### Licenciatura en Química Plan 2016 — damero 2026, proyecto y primer año en Salto operativos 2026-09-01

- El instructivo vigente de mayo de 2025, el damero aprobado por Resolución 112/2026, Facultad de Química y el catálogo vigente de Udelar confirman una única carrera de ocho semestres y 320 créditos, con título `Licenciado en Química`. Montevideo dicta la carrera completa; Salto ofrece exclusivamente el primer año y luego se continúa en Montevideo con el mismo plan, título y progreso.
- La UI ofrece dos recorridos territoriales, no dos carreras. Montevideo muestra la secuencia sugerida, la flexibilidad y el Proyecto Específico de Título; Salto muestra una orientación explícita y sólo cinco alternativas regionales identificadas en la composición oficial. El tramo parcial no expone Tesis, validación ni el catálogo completo como si pudieran cursarse allí.
- Los cinco primeros semestres seleccionan exactamente los 174 créditos obligatorios: 80 de ciencias físico-matemáticas, biológicas y otras, y 94 de ciencias químicas. El sexto semestre se completa con oferta flexible; los semestres 7 y 8 reúnen 20 créditos de asignaturas específicas y una Tesis de Grado de 40.
- El egreso controla por separado 76 créditos optativos/electivos con al menos 56 optativos, 10 de vinculación con el medio, 60 del Proyecto Específico de Título y 320 totales. La Tesis se exige una sola vez y la Comisión de Carrera valida la personalización y el egreso.
- Para iniciar el proyecto, el instructivo exige los 174 créditos básicos y al menos 40 optativos/electivos. Bedelías no publica una regla para la Tesis código `922`; la UI documenta esa condición y no inventa una previatura automática.
- La Resolución 112/2026 reemplaza Bioquímica Opción III de 15 créditos por Bioquímica Opción II de 10 más Laboratorio de Bioquímica de 5. Bedelías asigna 10 créditos al código `512`; la proyección usa los 5 específicos del damero y conserva la discrepancia trazada.
- FQ y CENURLN publican el mismo catálogo de 320 unidades y la misma huella curricular. La diferencia de cobertura de previaturas —125 reglas centrales contra 2 regionales— no prueba una variante curricular; la proyección conserva las reglas centrales y registra 91 consultas sin regla explícita.
- La proyección contiene 326 componentes: 322 apariciones de composición, tres bloques explicativos y una validación final. Las versiones históricas y las alternativas flexibles permanecen en el catálogo de Montevideo sin sumarse automáticamente ni convertirse en orientaciones certificadas.
- Registro de auditoría: hash `sha256:b434b16c3828ed9daf8064fa0bad4ce269913d529ae6633d78c401b2c4dba257`. Cola general: 5 identidades pendientes; hash `sha256:3bef45ff4a51709d9320183fd14e451c9fce35c72216862c0ce56a4f5c7f3ce6`.
- Manifiesto UI: 139 proyecciones, todas con composición utilizable y 46 con sedes oficiales; hash `sha256:51ee8c9cdf5caabf7c172e0a636750d10dbb6e7fcd413183d438daea0402ff51`. Cola funcional vacía; hash `sha256:202debe9aadb0cb5e192fc150cfe537a80bef3908c1b5ea1c2cc57774f9e8a5d`. La prueba determinista cubre identidad, sedes, damero, créditos, mínimos, proyecto, filtro territorial, previaturas y avance de cola.
- El navegador integrado no está disponible en esta sesión; no se declara una nueva inspección visual manual. Permanecen activas las pruebas estructurales de temas y adaptación móvil/tablet.
- Siguiente paso: auditar Licenciatura en Tecnologías de la Química Plan 2022, primera identidad reproducible restante.

### Licenciatura en Tecnologías de la Química Plan 2022 — dos orientaciones del mismo título operativas 2026-09-01

- El Plan 2022, Facultad de Química y el catálogo vigente de Udelar confirman una única carrera de 360 créditos y título `Licenciado en Tecnologías de la Química`, dictada en Montevideo. Biotecnología y Nanotecnología son orientaciones seleccionables del mismo título y progreso, no carreras independientes.
- La UI muestra para cada orientación su damero vigente de nueve semestres y mantiene fuera de la grilla las demás opciones acreditables. El catálogo se filtra por orientación y las 291 unidades normalizadas de Bedelías se conservan una sola vez, incluso cuando una unidad integra ambos perfiles o cumple funciones distintas en cada uno.
- El egreso controla 150 créditos básicos —50 físico-matemáticos y 100 químicos/biológicos—, 105 profesionales —90 tecnológicos o de segundo nivel y 15 empresariales—, 65 optativos/electivos con al menos 50 optativos de la orientación, 40 de Practicantado o Proyecto específico y 360 créditos totales.
- Practicantado y Proyecto específico son alternativas de la misma actividad final de 40 créditos. El damero vigente selecciona Proyecto; la credencial acepta cualquiera de las dos modalidades y la Comisión de Carrera valida las unidades obligatorias, la orientación, la flexibilidad y el egreso.
- Se preserva una discrepancia de duración: el Plan original define cuatro años y ocho semestres, mientras Udelar y Bedelías publican 60 meses y los dameros vigentes distribuyen la implementación en nueve semestres. La UI prioriza 60 meses y nueve semestres sin alterar el Plan 2022.
- Ambos dameros asignan 5 créditos a Laboratorio de Bioquímica código `512`, frente a 10 en Bedelías; la proyección usa 5. Además, el damero de Biotecnología ubica Laboratorio de Biotecnología `196` en su octavo semestre aunque la composición de Bedelías lo lista bajo optativas de Nanotecnología; se conserva la secuencia oficial y su cómputo profesional biotecnológico.
- La proyección contiene 294 componentes: 291 unidades únicas, dos orientaciones de flexibilidad y una validación final. Conserva 446 reglas de previatura publicadas y 31 consultas sin regla explícita.
- Registro de auditoría: hash `sha256:036f64646ece70c778261b9b8922d78aaf64c2006714c2d3da0f03b16f8d9fc0`. Cola general: 4 identidades pendientes; hash `sha256:db5311096e5c2ced2f9add94e433625ff866d5a7300d776ea0f64b276a5116a8`.
- Manifiesto UI: 139 proyecciones, todas con composición utilizable; hash `sha256:e2777043943b660ea5564e9150baddee1900657fed40ab352dab6188d0472776`. Cola funcional vacía; hash `sha256:24421b90b80c9cc001f598f680865bcbafcc2b468ab0e540eff8589c5dbb5de4`. La prueba determinista cubre carrera única, orientaciones, grillas, mínimos, actividad final, filtrado de catálogo, previaturas y avance de cola.
- El navegador integrado no está disponible en esta sesión; no se declara una nueva inspección visual manual. Permanecen activas las pruebas estructurales de temas y adaptación móvil/tablet.
- Siguiente paso: auditar Químico Plan 2015, primera identidad reproducible restante.

### Químico Plan 2015 — cuatro recorridos, Paysandú completo y primer año en Salto operativos 2026-09-01

- El Plan 2015, los cuatro dameros vigentes, Facultad de Química y los catálogos actuales de Udelar confirman una única carrera de diez semestres y 450 créditos, con título `Químico`. Agrícola y Medio Ambiente, Calidad, Materiales y Sin orientación son recorridos del mismo plan y progreso, no carreras ni títulos separados.
- Montevideo ofrece los cuatro recorridos completos. Paysandú ofrece completa la orientación Agrícola y Medio Ambiente; Salto ofrece sólo el primer año, con continuidad en Paysandú para completar esa orientación o en Montevideo según el recorrido elegido. Las unidades aisladas de Calidad y Materiales disponibles en el interior no se presentan como carreras regionales completas.
- Cada recorrido completo muestra su damero sugerido vigente y conserva las demás unidades acreditables en el catálogo. Salto muestra una orientación explícita y sólo 15 alternativas regionales de primer año identificadas en Bedelías; no expone actividad final, validación ni el catálogo completo como si pudieran cursarse allí.
- El egreso controla 205 créditos básicos —22 biológicos, 60 físico-matemáticos y 123 químicos de primer nivel—, 126 profesionales —42 empresariales, 43 químicos de segundo nivel y 41 tecnológicos—, 64 optativos/electivos con al menos 54 optativos, 55 de actividad final y 450 totales.
- Internado, Practicantado y Proyecto específico son tres alternativas oficiales de 55 créditos. La credencial exige una sola; los dameros vigentes sugieren Practicantado y la UI no obliga a estudiantes que hayan realizado otra modalidad a marcar una actividad distinta.
- Los dameros de Calidad y Sin orientación exigen una UC de cuatro créditos del Área Calidad sin fijar una asignatura única. Se conserva como instrucción de selección de crédito cero; sólo la unidad real elegida del catálogo suma créditos.
- FQ y CENURLN publican idéntica composición: 2381 apariciones, 33 grupos y 710 identidades normalizadas. La diferencia entre snapshots es únicamente la cobertura de previaturas —641 consultas/461 reglas centrales y 35/24 regionales—, por lo que no se crea una variante curricular regional.
- La proyección contiene 724 componentes: 714 filas de Bedelías que preservan variantes oficiales de código/crédito, cuatro bloques de flexibilidad, dos selecciones de Área Calidad, dos alternativas sintéticas de actividad final respaldadas por el Plan, una orientación territorial y una validación final. Conserva 461 reglas y 180 consultas sin regla publicada.
- Registro de auditoría: hash `sha256:990a5c632939e4c28079e225b53a63d733b431db6a4954f2b1eb5c5c5b066475`. Cola general: 3 identidades pendientes; hash `sha256:8a1b3820777caf9b080a3d4696c231505b529ee4f93e84d8f6424d8e73664598`.
- Manifiesto UI: 139 proyecciones, todas con composición utilizable y 47 con sedes oficiales; hash `sha256:b553b917c244f56cd5f1a95eb648f836ed85ef2db6c01c2401d2d615b62df12d`. Cola funcional vacía; hash `sha256:8fd4bae6ec1225730f03509487430c7ddbbb8777c023801638c244bbda188804`. La prueba determinista cubre identidad, recorridos, dameros, mínimos, alternativas de actividad final, alcance territorial, previaturas y avance de cola.
- El navegador integrado no está disponible en esta sesión; no se declara una nueva inspección visual manual. Permanecen activas las pruebas estructurales de temas y adaptación móvil/tablet.
- Siguiente paso: auditar Técnico Bachiller en Ciencias Químicas Plan 2015, primera identidad reproducible restante.

### Técnico Bachiller en Ciencias Químicas Plan 2015 — ingreso directo y primer año en Salto operativos 2026-09-04

- El Plan 2015, el damero vinculado a la Resolución 112/2026, Facultad de Química y el catálogo vigente de Udelar confirman una tecnicatura de ingreso directo, cinco semestres, 225 créditos y título `Técnico Bachiller en Ciencias Químicas`. No es el título intermedio Bachiller en Ciencias Químicas Plan 2000, que permanece como identidad histórica separada y sin ingreso propio.
- La UI publica una sola carrera y dos recorridos territoriales del mismo plan y progreso. Montevideo muestra la carrera completa; Salto muestra exclusivamente los dos primeros semestres y luego indica la continuidad en Montevideo. El tramo parcial no expone los semestres 3 a 5 ni la validación de egreso como si pudieran completarse allí.
- El damero vigente selecciona 24 unidades obligatorias que suman exactamente 175 créditos en cinco semestres: 26, 34, 39, 30 y 46. Incluye Bioquímica Opción II de 10 créditos y Laboratorio de Bioquímica de 5 en el quinto semestre.
- El egreso controla 175 créditos obligatorios —84 de ciencias físico-matemáticas, biológicas y otras, y 91 de ciencias químicas—, 50 optativos/electivos con al menos 35 optativos, las 24 unidades del núcleo vigente, 225 créditos totales y la validación del currículo flexible por la Comisión de Carrera.
- Salto reutiliza las nueve unidades canónicas del primer año y conserva como alternativas regionales las dos unidades `CBB22` y `CBB24` que la composición de Bedelías identifica explícitamente. No se inventan equivalencias para las demás implementaciones locales que sólo aparecen como referencias de previaturas.
- FQ y CENURLN publican la misma huella curricular de 489 unidades normalizadas sobre 491 apariciones. La diferencia es sólo de cobertura de previaturas: FQ registra 429 consultas, 149 reglas y 280 consultas sin regla; CENURLN registra nueve consultas sin regla. No se crea una variante curricular regional.
- La proyección contiene 493 componentes: 491 filas de composición, una orientación territorial y una validación final. Las versiones históricas, equivalencias y opciones flexibles permanecen en el catálogo de Montevideo sin sumarse automáticamente ni sustituir el núcleo vigente.
- Registro de auditoría: hash `sha256:9a8e2aa4a86714f65a877aa01d9aef7e03dca36726c514187f922f16a8b89d8d`. Cola general: 2 identidades pendientes; hash `sha256:a3626bd9a20d0af2dfae17767f0987216782e3d20b5ead614224b948a8206ba4`.
- Manifiesto UI: 139 proyecciones, todas con composición utilizable y 48 con sedes oficiales; hash `sha256:698ad94a93ffe17d980e1091bd69c9a5c01a242796bb6f1c8e2178a7ce6676eb`. Cola funcional vacía; hash `sha256:0cc5ce9d89eb931d9b50e9c1862dfe477e321320aac421c67eb5f6550863e8dd`. La prueba determinista cubre identidad, ingreso directo, sedes, damero, créditos, mínimos, filtro territorial, previaturas y avance de cola.
- El navegador integrado no está disponible en esta sesión; no se declara una nueva inspección visual manual. Permanecen activas las pruebas estructurales de temas y adaptación móvil/tablet.
- Siguiente paso: auditar Tecnicatura en Guardavidas Plan 2025, primera identidad reproducible restante.

### Tecnicatura en Guardavidas Plan 2025 — cuatro semestres y alternativa de políticas públicas operativos 2026-09-04

- El Plan oficial, el expediente de aprobación, la ficha vigente de ISEF y la convocatoria 2026 confirman una única Tecnicatura en Guardavidas de dos años, cuatro semestres y 160 créditos, con título `Técnico Guardavidas`. El CDC aprobó el plan el 01/10/2024; Bedelías lo identifica como Plan 2025 y su implementación vigente se abrió en Montevideo en 2026.
- La UI publica Montevideo como única sede confirmada del Plan 2025. Maldonado mantiene el Curso de Guardavidas Plan 2001 adecuación 2007; los antecedentes de futura implementación territorial no se presentan como una sede o trayectoria vigente de la nueva Tecnicatura.
- Los 134 créditos obligatorios se distribuyen en 50 de Salvamento Acuático, 42 de Geociencias y Salud y 42 de Ciencias Humanas y Sociales. La secuencia oficial suma 40, 32, 30 y 32 créditos en los cuatro semestres; los 26 restantes son optativos/electivos o acreditables mediante extensión, investigación, EFI y/o pasantías.
- El anexo normativo asigna 6 créditos a `Políticas Públicas y Salud / Políticas Públicas, Tiempo Libre y Ocio`. Bedelías publica ambas unidades por separado, por lo que la UI exige una de las dos y evita inflar el cuarto semestre o el núcleo obligatorio en 6 créditos.
- La proyección contiene 18 componentes: 16 unidades publicadas por Bedelías, un bloque explícito de 26 créditos de formación flexible y la validación final. El egreso controla las 14 unidades comunes, una de las dos alternativas de políticas públicas, los cuatro mínimos de área y 160 créditos totales.
- Las 16 consultas de Bedelías no publican reglas explícitas de previaturas. Se conserva esa ausencia como dato y no se inventan correlatividades; la Comisión de Carrera valida equivalencias, acreditaciones flexibles y egreso.
- Registro de auditoría: hash `sha256:06e2140d7a34dbf0f88b39db841de08b4707b99a7a945e0fcd03c4b7d06675ec`. Cola general: 1 identidad pendiente; hash `sha256:43010d3a5608d62d86edb6cf272170d80e1b3eba7ea5409ed76856b259881051`.
- Manifiesto UI: 139 proyecciones, todas con composición utilizable; hash `sha256:a67e9e1cd3e69b83b0ae1008016b2c026509ac0d45456176bffd92d0b991a606`. Cola funcional vacía; hash `sha256:55f6c33f6657034dc2c6976bcbd93a250525bdb9854600ea7aa42ba367df93b8`. La prueba determinista cubre identidad, sede, secuencia semestral, mínimos, alternativa, formación flexible, ausencia de previaturas y avance de cola.
- El navegador integrado no está disponible en esta sesión; no se declara una nueva inspección visual manual. Permanecen activas las pruebas estructurales de temas y adaptación móvil/tablet.
- Siguiente paso: auditar Odontología Plan 2011, última identidad reproducible pendiente.

### Odontología Plan 2011 — núcleo vigente, flexibilidad y previaturas operativos 2026-09-04

- El Plan 2011, la malla vigente de Facultad de Odontología, su reglamento actualizado y el catálogo actual de Udelar confirman una única carrera de 495 créditos, título `Doctor en Odontología` y carrera completa en Montevideo. El plan organiza nominalmente cinco años y medio/once semestres; el catálogo central redondea la duración a 60 meses y la UI conserva 66 meses por coincidir con la secuencia curricular oficial.
- La trayectoria muestra por año las 40 unidades troncales publicadas por Facultad: 10 en primero, 8 en segundo, 9 en tercero, 5 en cuarto, 6 en quinto y Pasantía 3 más Trabajo Final de Carrera en el semestre 11. El núcleo suma 465 créditos y los 30 restantes corresponden a formación flexible.
- El egreso controla 40 créditos de Introducción y Salud Colectiva, 90 de Bases Biológicas, 37 de Patología, 230 de Formación Clínico-Profesional, 50 de Servicios y Comunidad, 18 de Formación General/Trabajo Final y 30 flexibles. También exige las 40 unidades troncales, el Trabajo Final de 10 créditos y la validación administrativa final.
- La tabla original del Plan proyectaba 89/44/40/222/50/50 créditos por área. La malla vigente y las reglas operativas de Bedelías reflejan el núcleo 40/90/37/230/50/18 más 30 flexibles; la UI usa esta estructura actual sin alterar el total oficial de 495 y deja trazada la diferencia.
- La composición de Bedelías contiene 376 ofertas, normalizadas en 332 actividades del snapshot. La UI conserva el catálogo completo: separa las optativas propias de las electivas de otros servicios y no convierte ninguna en obligatoria por aparecer publicada.
- BBO 1 y 2 agregadas, la versión anterior de Iniciación a la Investigación, Tratamiento de Enfermedades Prevalentes 1 y Oclusión/Prostodoncia permanecen visibles para equivalencias con cero créditos. Así no duplican las unidades vigentes por disciplinas o combinadas; la Comisión Académica de Carreras valida cada equivalencia.
- Se conservan 112 previaturas publicadas y 211 consultas sin regla explícita. Se corrigió el generador para reconstruir los identificadores al sustituir una proyección cruda por el árbol de composición: las 112 reglas ahora apuntan a cursos existentes y no a IDs reservados de la versión descartada.
- Asistente e Higienista Plan 2011 figuran institucionalmente como títulos intermedios de 180 y 270 créditos, además de las carreras de ingreso directo Plan 2017. No se habilitan automáticamente dentro del progreso de Odontología porque las fuentes consultadas no publican reglas completas de egreso intermedio; alcanzar sólo el total de créditos no es suficiente.
- Registro de auditoría: hash `sha256:f23ca3e9501660613c08e03d63a043d1ab8396817bc923d7e1efe0b3fe16aa15`. Cola general cerrada: 184 identidades canónicas, 177 cerradas por evidencia, 7 auditorías previas y 0 pendientes; hash `sha256:7cfbd0e1da2c1a7ea3fd9a66d63e9097bdfcae2cca99da91ba058b79c4d9591c`.
- Manifiesto UI: 139 proyecciones, todas con composición utilizable, 48 con sedes oficiales y 38 identidades históricas/excluidas; hash `sha256:ca334fbcc7babcf33516a137d746faa77c7aba3eacd5089ef9c351dac6d0a9aa`. Cola funcional cerrada; hash `sha256:12e58a2438a303348cefdd3c1b58f92eb8ba77a93f70bfde0c402a82517a232f`.
- La verificación final abrió la UI local en el navegador integrado y recorrió Odontología: selección académica, 495 créditos, requisitos, búsqueda y detalle de Trabajo Final. Las cinco familias de color, modo oscuro y modo daltónico respondieron sin errores de consola; en 390×844 no hubo desborde horizontal inesperado y en 768×1024 el único desborde observado fue el carrusel curricular deliberadamente desplazable. La captura de pantalla del navegador no estuvo disponible, por lo que no se declara una revisión visual píxel a píxel.
- Verificación global final: `npm test` 752/752, `npm run lint` sin errores y `npm run build` completo. El plan queda cerrado en esta rama y listo para revisión e integración autorizada; no integrar `main`, hacer push, desplegar ni publicar desde este worktree.

### Revisión de integración y reglas de Bedelías 2026-09-05

- La cadena global quedó reunida en el worktree de revisión sin publicar ni modificar `main`. La auditoría estricta detectó inicialmente 60 reglas lógicas incompletas, concentradas en 11 planes de CURE, FAGRO, FING, FQ e ISEF.
- Se reextrajeron secuencialmente sólo esos objetivos, a 500 ms y reutilizando checkpoints. La auditoría estricta final no conserva grupos lógicos incompletos; los artefactos de aplicación, inventarios y reportes afectados fueron regenerados sin relanzar planes ya completos.
- El aviso genérico del Planificador dejó de decir `Armá una currícula propia`: ahora aclara que la persona organiza cómo piensa cursar las materias del plan y que esa planificación no modifica requisitos, horas o créditos ni áreas oficiales. Una prueba determinista impide que vuelva la formulación ambigua.
- Dieciséis planes visibles —once vigentes y cinco históricos— publican materias y requisitos, pero no valores de créditos ni horas. En esos casos la UI ahora mide el Planificador por cantidad de materias y el avance por requisitos oficiales, identifica la carga como no publicada y evita presentar `0 cr.` como si fuera un dato académico. Los restantes planes visibles tienen créditos con mínimo total o carga horaria total, por lo que no requieren este fallback.
- La validación local recorrió Hemoterapia Plan 2006 con sus sedes Montevideo y Paysandú. El mensaje corregido y los selectores funcionaron sin errores de consola ni desborde horizontal inesperado en 390×844, 768×1024 y 1440×900; también respondieron las cinco familias de color en claro y oscuro y el modo daltónico. La captura del navegador no estuvo disponible, por lo que esta comprobación fue funcional y de layout calculado, no una revisión píxel a píxel.
- Verificación final de esta revisión: `npm test` 758/758, `npm run lint` sin errores, compilación incluida en la suite completa y `npm run bedelias:audit-rules -- --strict` sin grupos incompletos. El resultado queda preparado como commit recuperable; sigue prohibido integrar `main`, hacer push, desplegar o publicar sin autorización.
