...
test("renderiza la malla y su procedencia institucional", async () => {
  ...
  assert.match(html, /rel="icon"[^>]*href="\/udelar\.svg\?v=3"[^>]*type="image\/svg\+xml"/i);
  assert.doesNotMatch(html, /href="\[object Object\]"/i);
  ...
  assert.match(html, /class="requirement-heading"[^>]*aria-expanded="false"/);
  assert.doesNotMatch(html, /60 cr\. flexibles dentro del grupo/, "las metas detalladas empiezan plegadas");
