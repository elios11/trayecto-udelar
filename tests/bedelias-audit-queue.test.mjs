...
test("genera una cola canónica deduplicada y dirigida por excepciones", () => {
  ...
  assert.equal(saved.counts.evidenceClosedCanonicalIdentities, 176);
  assert.equal(saved.counts.pendingCanonicalIdentities, 1);
  assert.deepEqual(saved.counts.byPriority, {
    "official-sources-pending": 1,
  });
  ...
  assert.deepEqual(saved.completedAudits.slice(85).map((entry) => entry.identity), [
    ...
    "licenciatura biologia humana:2004",
    "licenciatura en astronomia:2016",
    "licenciatura en bioquimica:2017",
    "licenciatura en ciencias biologicas:2017",
    "licenciatura en ciencias de la atmosfera:2007",
    "licenciatura en fisica:2019",
    "licenciatura en fisica medica:2025",
    "licenciatura en geografia:2018",
    "licenciatura en geologia:2018",
    "licenciatura en matematica:2014",
    "licenciatura en relaciones internacionales:2013",
    "traductorado publico aleman:2022",
    "traductorado publico frances:2022",
    "traductorado publico ingles:2022",
    "traductorado publico italiano:2022",
    "traductorado publico portugues:2022",
    "antropologia:2014",
    "correccion de estilo:2014",
    "dramaturgia:2015",
    "educacion:2014",
    "filosofia:2010",
    "historia:2014",
    "interpretacion lsu espanol lsu:2014",
    "letras:2014",
    "licenciatura en estudios sordos:2025",
    "tecnologo int y trad lsu esp:2025",
    "linguistica:2014",
    "museologia:2011",
    "licenciatura en ingenieria de medios:2018",
    "ingenieria de alimentos:2003",
    "ingenieria de produccion:2010",
    "ingenieria en agrimensura:2023",
    "ingenieria en sistemas de comunicacion:2018",
    "ingenieria fisico matematica:2017",
    "ingenieria industrial mecanica:1997",
    "ingenieria naval:1997",
    "ingenieria quimica:2021",
    "licenciatura en computacion:2025",
    "tecnologo en cartografia:2011",
    ...
    "tecnicatura en guardavidas:2025",
  ]);
...
test("la cola guardada se reconstruye sin red con el mismo hash", () => {
  ...
  assert.equal(rebuilt.queue[0].identity, "odontologia:2011");
});
