...
- Bedelías inventaría 184 identidades canónicas como vigentes de grado, tecnicatura, tecnólogo y CIO. La auditoría oficial excluye de la UI actual la Diplomatura en Música Plan 1994, sustituida por las Tecnicaturas de Salto, por lo que la aplicación ofrece 183 identidades vigentes y conserva además el Plan 1997 histórico de Ingeniería en Computación. Ocho planes tienen proyecciones curadas específicas; otros 176 se generan desde snapshots. Diez de estos últimos ya incorporan sedes verificadas oficialmente y los restantes identifican su composición de Bedelías como pendiente o completada según la auditoría disponible.
...
- Las auditorías oficiales de nueve planes generados alimentan sus sedes y metadatos normalizados. Educación Física filtra sus trayectos según la sede y la Tecnicatura en Deportes vincula cada opción deportiva con su localización y estado de ingreso; las vías regionales de primer año no se muestran como sedes completas. Estas proyecciones siguen sin ser elegibles para publicación automática.
