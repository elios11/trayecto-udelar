...
- Bedelías inventaría 184 identidades canónicas como vigentes de grado, tecnicatura, tecnólogo y CIO. Veinticuatro auditorías resolvieron falsos vigentes o títulos históricos convertidos y tres más resolvieron aliases administrativos del Plan 2012 de Comunicación; las veintisiete se excluyen del selector actual. La aplicación ofrece así 157 identidades vigentes y conserva además el Plan 1997 histórico de Ingeniería en Computación. Ocho planes tienen proyecciones curadas específicas y otros 150 se generan desde snapshots y auditorías; 72 identidades canónicas ya tienen evidencia oficial cerrada. La cola conserva 105 identidades pendientes de contraste oficial y la UI tiene 127 proyecciones generadas con malla utilizable y 23 todavía sin composición; estas últimas requieren localizar y auditar fuentes curriculares oficiales.
