...
- La aplicacion trabaja con Ingeniería en Computación (planes 1997 y 2025), Ingeniería Eléctrica (Plan 2023) e Ingeniería Civil (Plan 2021) de la Facultad de Ingeniería; Química Farmacéutica (Plan 2015) de Facultad de Química; y Arquitectura (Plan 2015), Diseño de Comunicación Visual (Plan 2007) y Diseño Industrial (Plan 2013) de FADU.
...
- La jerarquia de facultades, carreras y planes, junto con sus identificadores tipados, vive en `app/academic-catalog.ts`; los registros de estado por plan se inicializan desde ese catalogo. Los datasets incorporados por el flujo masivo se registran para carga diferida en `app/academic-plan-registry.ts`, sin condicionales por carrera en la interfaz central.
