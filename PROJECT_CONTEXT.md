...
- Las auditorías oficiales de doce planes generados alimentan sus sedes y metadatos normalizados. Educación Física filtra sus trayectos según la sede y la Tecnicatura en Deportes vincula cada opción deportiva con su localización y estado de ingreso; las vías regionales de primer año no se muestran como sedes completas. Una auditoría puede aportar una malla oficial estructurada cuando el snapshot de Bedelías está vacío, conservando una procedencia distinta de Bedelías y sin inventar previaturas. Estas proyecciones siguen sin ser elegibles para publicación automática.
